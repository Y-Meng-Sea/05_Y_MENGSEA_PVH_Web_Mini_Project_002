     ...
     return (
          <div className="border border-gray-300 rounded-xl mt-8">
               <div className="p-5">
                    ...
                    {/* task detials */}
                    <p className="line-clamp-2 text-light-steel-blue my-2 h-12">{props.taskDetails}</p>

                    <div className="flex justify-between items-center mt-4">
                         {/* tag */}
                         <p className="bg-purple-100 text-purple-500 py-1.5 px-3 rounded-lg">{props.tag}</p>

                         {/* status */}
                         <div className={`rounded-full w-8 h-8 ${handleStatusColor(props.status)}`}></div>
                    </div>
               </div>
